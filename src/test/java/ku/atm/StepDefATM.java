...
public class StepDefATM {
    ...
    @Then("I cannot login with this id: {int}")
    public void I_cannot_login_with_this_id(int id) {
        assertFalse(validLogin, "Login should not be valid for id: " + id);
    }
    ...
    public void i_deposit_amount_into_atm(double amount) {
        atm.deposit(amount);
    }
